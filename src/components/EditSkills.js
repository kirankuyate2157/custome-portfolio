...
const EditSkills = ({ skillsData, onSave, onDelete }) => {
  ...
  return (
    <div className="font-mono">
      <div className=" m-2 bg-transparent border-2 border-gray-600 p-3 rounded-lg  text-white shadow-lg  flex items-center justify-between">
        <div className="w-full grid grid-flow-row grid-cols-12 ">
          <h3 className="text-lg font-semibold col-span-5">{skillsData.name}</h3>
