      ...
      <div className='w-screen mb-5 font-mono text-black dark:text-white flex flex-col'>
        <div className='w-full flex justify-between items-center text-white p-4'>
          <h2 className='text-xl sm:text-base px-3 py-1 flex items-center gap-1 rounded-full bg-pink-800 border border-primary font-semibold'>
            <span class='cursor-pointer'>Data</span> <span className='w-[2px] h-[80%] bg-gray-500 mx-1' /> | Edit Articles{' '}
            <FiChevronRight />
          </h2>
        </div>
          ...
          <ul className='space-y-4'>
            <li className='bg-transparent border-2 shadow-md shadow-pink-300 border-gray-600 p-2 rounded-lg'>
              <div className='flex items-center justify-between cursor-pointer'>
                <strong className='cursor-pointer ml-1 font-extrabold' onClick={() => setRecentAllClose(!recentClose)} >Recent articles</strong>
                <div className='flex gap-3 text-2xl'>
                  <button onClick={addToArticles}>
                    <BiAddToQueue />
                  </button>
                  <button className='text-pink-600 flex text-3xl font-bold hover:text-indigo-800' onClick={() => setRecentAllClose(!recentClose)}>
            ...
            <li className='bg-transparent border-2 shadow-md shadow-pink-300 border-gray-600 p-2 rounded-lg'>
              <div className='flex items-center justify-between cursor-pointer' >
                <strong className='cursor-pointer ml-1 font-extrabold' onClick={() => setAllClose(!allClose)} >All articles</strong>
                <div className='flex gap-3 text-2xl'>
