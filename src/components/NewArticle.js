...
import { useAboutData } from "../context/DashboardDataProvider";
...
const NewArticle = () => {
    ...
    const handleSaveArticle = (updatedArticle, title) => {
        ...
        const indexToUpdate = updatedArticlesData.findIndex((article) => article.title === title);
                            ...
                            <div>
                                ...
                                {articlesData.map((article, index) => (
                                    <EditArticle
                                        ...
                                        articleData={article}
                                        onSave={(newD, title) => { handleSaveArticle(newD, title) }}
                                        onDelete={(title) => { handleDeleteArticle(title) }}
                                    />
                                ))}
                            ...
                            <div>
                                ...
                                {allArticlesData.map((article, index) => (
                                    <EditArticle
                                        key={`${index}+${article.title}`}
                                        articleData={article}
                                        onSave={(newD, title) => { handleSaveAllArticle(newD, title) }}
                                        onDelete={(title) => { handleDeleteAllArticle(title) }}
                                    />
                                ))}
